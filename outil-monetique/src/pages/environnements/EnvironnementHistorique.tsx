...
import type { Environnement, Personne } from '../../lib/types';

export function EnvironnementHistorique({ environnement, personnes }: { environnement: Environnement; personnes: Personne[] }) {
  ...
  const evenements = journal
    .filter((entree) => entree.typeObjet === 'environnement' && entree.objetId === environnement.id)
