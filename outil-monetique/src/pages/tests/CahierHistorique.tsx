...
import type { CahierDeTest, Personne } from '../../lib/types';

export function CahierHistorique({ cahier, personnes }: { cahier: CahierDeTest; personnes: Personne[] }) {
  ...
  const evenements = journal
    .filter((entree) => entree.typeObjet === 'cahierTest' && entree.objetId === cahier.id)
