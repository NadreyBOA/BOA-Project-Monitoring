...
export default function TransactionFormScreen() {
  ...
  return (
    <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      <Stack.Screen options={{ title: 'Nouvelle transaction' }} />
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.segmented}>
          ...
          >
            <Text style={[styles.segmentText, type === 'credit' && styles.segmentTextActive]}>Crédit (achat)</Text>
          </Pressable>
          <Pressable
            style={[styles.segment, type === 'payment' && styles.segmentActivePayment]}
            onPress={() => setType('payment')}
          >
            <Text style={[styles.segmentText, type === 'payment' && styles.segmentTextActive]}>
        ...
        <TextInput
          ...
          placeholder="Ex: sac de riz, huile..."
          placeholderTextColor={colors.textMuted}
